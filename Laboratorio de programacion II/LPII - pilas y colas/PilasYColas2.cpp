...
// Este programa recibe una expresión algebraica compuesta de números y operaciones
// de + - * / y % en notación infija y la transforma en notación Prefija y Postfija.
// En caso de poner números de más de un dígito, a la salida no se notará la diferencia.
